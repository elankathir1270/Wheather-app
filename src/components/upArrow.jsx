export const UpArrow = () => {
  return (
	...
	C0,78.4,78.4,0,175.2,0h145.6C417.6,0,496,78.4,496,175.2V320.8z"
      ...
      <path
       style={{fill:"#0ACC13"}}
        d="M0,175.2C0,78.4,78.4,0,175.2,0h145.6C417.6,0,496,78.4,496,175.2v145.6
	c0,96.8-78.4,175.2-175.2,175.2"
      ...
      <g>
        ...
        <path
         style={{fill:"#06C125"}}
          d="M303.2,235.2L256,188.8c-4.8-4.8-12-4.8-16.8,0l-46.4,46.4c-4.8,4.8-4.8,12,0,16.8s12,4.8,16.8,0
      ...
      <path
       style={{fill:"#FFFFFF"}}
        d="M303.2,218.4L256,172c-4.8-4.8-12-4.8-16.8,0l-46.4,46.4c-4.8,4.8-4.8,12,0,16.8s12,4.8,16.8,0
